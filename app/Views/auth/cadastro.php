                     ...
                     <div class="card-inner card-inner-sm">
                        <div class="nk-block-head">
                           <div class="nk-block-head-content">
                              <h4 class="nk-block-title" style="font-size:medium;">TESTE GRÁTIS POR 7 DIAS</h4>
                           </div>
                        </div>
                        <form id="cadForm">
                           <!-- Nome da Empresa -->
                           <div class="form-group" style="margin-bottom: 0.5rem;">
                              ...
                              <div class="form-control-wrap">
                                 <input type="text" class="form-control form-control-lg" id="nome_empresa"
                                    name="nome_empresa" placeholder="Informe o nome da empresa">
                              </div>
                           </div>
                           ...
                           <div class="form-group" style="margin-bottom: 0.5rem;">
                              ...
                              <div class="form-control-wrap">
                                 <input type="password" class="form-control form-control-lg" name="confirma_senha"
                                    id="confirma_senha" placeholder="Repita a senha">
                                 <small id="feedback-senha" class="form-text mt-1 d-block"
                          ...
                          <div class="form-group" style="margin-bottom: 0.5rem;">
                              <button class="btn btn-lg btn-dark btn-block" id="btnEntrar">
                                 Cadastrar
                              </button>
                           </div>
                        </form>
      ...
      $('#btnEntrar').on('click', function(e) {
         ...
         $.ajax({
            ...
            success: function(response) {
               if (response.success) {
                  // Sucesso: Redireciona de forma limpa para a tela de login
                  // O Flashdata criado no Controller cuidará de exibir a mensagem lá.
                  window.location.href = response.redirect;
               } else {
                  // Erro: Exibe a mensagem de erro na própria página de cadastro
