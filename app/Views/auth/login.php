          ...
          <div class="nk-content ">
            <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
              <div class="brand-logo pb-4 text-center">
                <div class="logo-link"><img class="logo-light logo-img logo-img-lg" src="<?= base_url() ?>images/logo.png" srcset="/demo3/images/logo.png 2x" alt="logo"><img class="logo-dark logo-img logo-img-lg" src="<?= base_url() ?>images/logo.png" srcset="/demo3/images/logo.png 2x" alt="logo-dark"></div>
              ...
              <div class="">
                ...
                <div class="card-inner card-inner-lg">
                  ...
                  <form id="loginForm">
                    ...
                    <div class="form-group">
                      <div class="form-label-group"><label class="form-label" for="password">Senha</label><a class="link link-primary link-sm" href="auth-reset-v2.html">Esqueceu a senha?</a></div>
                    ...
                    <div class="form-group"><button class="btn btn-lg btn-primary btn-block" id="btnEntrar">Entrar</button></div>
                  </form>
                  <div class="form-note-s2 text-center pt-4"> Não possui uma conta ? <a href="cadastro">Cadastre-se</a></div>
                </div>
              </div>
            </div>
