...
<body class="nk-body npc-default pg-auth">
   ...
   <div id="pwa-loader"
      ...
      <img src="<?= base_url() ?>images/logo.png" alt="Softec"
            ...
            <div class="nk-content ">
               <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                  <div class="brand-logo pb-4 text-center">
                     <div class="logo-link"><img class="logo-light logo-img logo-img-lg"
                           src="<?= base_url() ?>images/logo.png" srcset="/demo3/images/logo.png 2x" alt="logo"><img
                           class="logo-dark logo-img logo-img-lg" src="<?= base_url() ?>images/logo.png"
                           srcset="/demo3/images/logo.png 2x" alt="logo-dark"></div>
                  ...
                  <div class="">
                        ...
                        <div class="pwa-banner-content">
                           ...
                           <div class="pwa-actions">
                              ...
                              <div id="ios-instruction" class="ios-instruction d-none"
                                 ...
                                 Toque em <b>Compartilhar</b> <i class="fas fa-share-square"></i> e depois em
                     ...
                     <div class="alert alert-fill alert-success alert-dismissible fade show shadow-sm mb-3"
                        role="alert">
        ...
        <div class="nk-block-des">
            <p>Bem-vindo(a) ao sistema.</p>
                        ...
                        <form id="loginForm">
                           ...
                           <div class="form-group">
                              <div class="form-label-group"><label class="form-label" for="password">Senha</label><a
                                    class="link link-primary link-sm" href="auth-reset-v2.html">Esqueceu a senha?</a>
                              </div>
