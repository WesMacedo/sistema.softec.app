...
<head>
   ...
   <link rel="stylesheet" href="<?= base_url() ?>assets/css/dashlite9b70.css?ver=3.3.1">
   <link id="skin-default" rel="stylesheet" href="<?= base_url() ?>assets/css/theme9b70.css?ver=3.3.1">
...
<body class="nk-body npc-default pg-auth">
   ...
   <div id="pwa-loader"
      style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: #f5f6fa; display: flex; flex-direction: column; justify-content: center; align-items: center; z-index: 999999; transition: opacity 0.4s ease;">
      <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="83.6488mm" height="14.3932mm" version="1.1"
         viewBox="0 0 8364.88 1439.32">
