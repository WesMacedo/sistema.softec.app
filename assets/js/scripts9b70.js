    ...
    p.ClassBody = function() {
        ...
        x(e).exists() && x(e).each(function() {
            var e = x(this).data("auto-responsive"),
                ...
                a = x(this).data("export-title") ? x(this).data("export-title") : "Export",
                i = t ? '<"dt-export-buttons d-flex align-center"<"dt-export-title d-none d-md-inline-block">B>' : "",
                t = t ? " with-export" : "",
                o = '<"row justify-between g-2' + t + '"<"col-7 col-sm-4 text-start"f><"col-5 col-sm-8 text-end"<"datatable-filter"<"d-flex justify-content-end g-2"' + i + 'l>>>><"datatable-wrap ' + n + ' my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>',
                t = '<"row justify-between g-2' + t + '"<"col-7 col-sm-4 text-start"f><"col-5 col-sm-8 text-end"<"datatable-filter"<"d-flex justify-content-end g-2"' + i + 'l>>>><"' + n + ' my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>',
                i = {
                    responsive: !0,
                    autoWidth: !0,
        ...
        function y(e) {
            ...
            1 === t && (c.style.display = "block", r.style.display = "none", l.style.display = "none", n.setAttribute("data-step-current", "Primeiro")), h !== t & 1 !== t && (r.style.display = "block", c.style.display = "block", l.style.display = "none", n.setAttribute("data-step-current", t)), h === t && (r.style.display = "block", l.style.display = "block", c.style.display = "none", n.setAttribute("data-step-current", "Ultimo")), b && (o.innerHTML = "".concat(e, " of ").concat(h), s.style.width = "".concat(100 / h * e, "%"))
        }
        m !== h && v ? console.error("A navegação do stepper deve ter a mesma quantidade de elementos filhos que as etapas do stepper.") : y(e);
